...
(Set a) Int 
--lista sin repetidos   longitud de la lista

emptyS = Set a
emptyS = [] Int

lenghtQ :: Queue a -> Int
lenghtQ q = 1 + lenght (dequeue q) 

queueToList :: Queue a -> [a]
queueToList q = if isEmptyQ q 
					then []
					else firstQ q : dequeue (queueToList q)  


unionQ :: Queue a -> Queue a -> Queue a
unionQ q1 q2 = enqueue (queueToList q2) q1
...
object pepe{
	...
	method sueldo(){
        self.sueldoNeto() + bonoPresentismo + bonoResultados
	}
}
...
object moria{
    ...
    method sueldo(){
        return (categoria.sueldoNeto() * 1.3) + bonoResultados
    }
...
object roque{
        ...
        method sueldo(){
            return sueldoNeto + bonoResultados + 9000
        }
}
